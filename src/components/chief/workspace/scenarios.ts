        ...
        blocks: [
          {
            ...
            people: [{
              ...
              coordonnees: [{ canal: "e-mail", valeur: "demo.amine@exemple.test", fiabilite: "vérifiée en interne", principale: true }],
            }],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            actions: [
              { libelle: "Relancer le responsable", phrase: "Relance Démo Benkaci sur le dossier DEMO-2026-018" },
              { libelle: "Voir le dossier", phrase: "Ouvre le dossier DEMO-2026-018" },
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            title: "La preuve",
            docs: [{
              nom: "Courrier ANPP — 25/08/2026 (Démo).pdf",
              href: "#demo",
              type: "pdf",
              soustitre: "Complément de stabilité à 24 mois demandé",
              pages: 2,
            }],
          },
        ],
