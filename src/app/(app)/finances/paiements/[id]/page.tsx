...
export default async function PaymentRequestPage({ params }: { params: { id: string } }) {
  ...
  if (!isFinance && !isRequester && req.recipientId !== user.id) redirect("/finances/paiements");
  ...
  return (
    <div className="space-y-5">
      <BackLink href="/finances/paiements"><ArrowLeft className="h-4 w-4" /> Demandes de paiement</BackLink>
