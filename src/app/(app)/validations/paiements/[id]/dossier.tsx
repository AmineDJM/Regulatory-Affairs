...
import {
  ...
  MessageSquare, Download, Paperclip,
} from "lucide-react";
...
import { PAYMENT_PIECE_STATUS, PAYMENT_PIECE_KIND, PAYMENT_PIECE_KIND_OPTIONS } from "@/lib/labels";
...
export function PaymentDossier({
  id, status, isRequester, isFinance, pieces, events, people, canApproveNow, approveBlocker, resubmitBlocker,
}: {
  id: string;
  status: string;
  isRequester: boolean;
    ...
    <div className="space-y-5">
      ...
      <section className="space-y-3">
        <div className="flex flex-wrap items-center gap-2">
          <h2 className="text-sm font-semibold">Pièces du dossier</h2>
