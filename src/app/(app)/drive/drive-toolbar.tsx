...
import { MoreHorizontal, Trash2, Maximize2, Minimize2, Settings2 } from "lucide-react";
        ...
        {open && (
          <>
            ...
            <div className="absolute right-0 top-full z-20 mt-1 w-56 overflow-hidden rounded-xl border border-border bg-popover p-1 shadow-xl">
              ...
              >
                {wide ? <Minimize2 className="h-4 w-4 text-muted-foreground" /> : <Maximize2 className="h-4 w-4 text-muted-foreground" />}
