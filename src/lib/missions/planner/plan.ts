...
23. UN LIVRABLE SE PRODUIT UNE FOIS, QUAND LES DONNÉES SONT LÀ. N'écris pas une pièce « provisoire » puis une pièce « définitive » du MÊME format : la première partira avant les réponses, elle sera vide de ce qu'on attendait, et le dirigeant se retrouvera avec deux fichiers qui divergent sans savoir lequel lire. Un état intermédiaire est une étape WORKER — elle porte le résultat sans déposer de fichier. Deux pièces du même format sont légitimes quand elles sont INDÉPENDANTES (deux contrats, deux comptes rendus), jamais quand l'une descend de l'autre.
