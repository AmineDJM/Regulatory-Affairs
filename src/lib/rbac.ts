...
export const MODULES = [
  "DASHBOARD", "REGULATORY", "SPONSORING", "BUDGETS", "FINANCES", "CONGRESS_INTERNATIONAL",
...
export const PERMISSIONS: Record<UserRole, RoleMatrix> = {
  ...
  DIRECTION: {
    ...
    BUDGETS: [...READ, "VALIDATE"], FINANCES: [...READ, "VALIDATE"], CONGRESS_INTERNATIONAL: [...READ, "VALIDATE"],
  ...
  FINANCE_BUDGET_MANAGER: {
    DASHBOARD: READ, BUDGETS: MANAGE, FINANCES: MANAGE, SPONSORING: READ, SALES: READ, LOGISTICS: READ,
