...
export const MODULES = [
  ...
  "BUSINESS_DEVELOPMENT", "PCH", "STOCKS", "MEDICAL_INFO", "VALIDATIONS", "DIRECTIVES", "SUPPORT", "DOSSIERS", "DOCUMENTS", "DRIVE", "ADMIN_REQUESTS", "NOTIFICATIONS",
...
export const PERMISSIONS: Record<UserRole, RoleMatrix> = {
  ...
  DIRECTION: {
    ...
    MEDICAL_INFO: READ_VALIDATE, DIRECTIVES: MANAGE, SUPPORT: MANAGE, DOSSIERS: MANAGE, NOTIFICATIONS: ["VIEW"], ADMIN: ["VIEW", "EXPORT"],
  },
  HEAD_OF_REGULATORY: {
  ...
  MEDICAL_PROMOTION_MANAGER: {
    DASHBOARD: READ, WORKSPACE: WORKSPACE_USER, MESSAGING: MESSAGING_USER, VALIDATIONS: VALIDATION_USER, DRIVE: DRIVE_USER, ADMIN_REQUESTS: REQUEST_USER, MEDICAL: MANAGE, EVENTS: MANAGE, CONGRESS_NATIONAL: CONTRIBUTE, CONGRESS_INTERNATIONAL: CONTRIBUTE, DOCUMENTS: CONTRIBUTE, DIRECTIVES: DIRECTIVES_USER, SUPPORT: SUPPORT_USER, DOSSIERS: DOSSIERS_USER, NOTIFICATIONS: ["VIEW"],
  },
  ...
  FINANCE_BUDGET_MANAGER: {
    ...
    DOCUMENTS: READ, MEDICAL_INFO: ["VIEW", "UPLOAD"], DIRECTIVES: DIRECTIVES_USER, SUPPORT: SUPPORT_USER, DOSSIERS: DOSSIERS_USER, NOTIFICATIONS: ["VIEW"],
  },
