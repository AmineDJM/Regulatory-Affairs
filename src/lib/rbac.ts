...
export const PERMISSIONS: Record<UserRole, RoleMatrix> = {
  ...
  DIRECTION: {
    ...
    BUDGETS: READ_VALIDATE, FINANCES: READ_VALIDATE, RH: MANAGE, CONGRESS_INTERNATIONAL: READ_VALIDATE,
    CONGRESS_NATIONAL: READ_VALIDATE, SALES: READ_VALIDATE, LOGISTICS: READ_VALIDATE, PCH: READ_VALIDATE,
