...
export const MODULES = [
  ...
  "BUSINESS_DEVELOPMENT", "PCH", "STOCKS", "VALIDATIONS", "DOCUMENTS", "DRIVE", "ADMIN_REQUESTS", "NOTIFICATIONS", "ADMIN",
] as const;
...
export const PERMISSIONS: Record<UserRole, RoleMatrix> = {
  ...
  DIRECTION: {
    DASHBOARD: READ, WORKSPACE: WORKSPACE_USER, MESSAGING: MESSAGING_USER, VALIDATIONS: VALIDATION_USER, DRIVE: DRIVE_USER, ADMIN_REQUESTS: REQUEST_USER, REGULATORY: [...READ, "VALIDATE"], SPONSORING: [...READ, "VALIDATE"],
    BUDGETS: [...READ, "VALIDATE"], FINANCES: [...READ, "VALIDATE"], RH: MANAGE, CONGRESS_INTERNATIONAL: [...READ, "VALIDATE"],
    CONGRESS_NATIONAL: [...READ, "VALIDATE"], SALES: READ, LOGISTICS: READ, PCH: [...READ, "VALIDATE"], STOCKS: READ, MEDICAL: READ,
  ...
  MEDICAL_PROMOTION_MANAGER: {
    DASHBOARD: READ, WORKSPACE: WORKSPACE_USER, MESSAGING: MESSAGING_USER, VALIDATIONS: VALIDATION_USER, DRIVE: DRIVE_USER, ADMIN_REQUESTS: REQUEST_USER, MEDICAL: MANAGE, CONGRESS_NATIONAL: CONTRIBUTE, CONGRESS_INTERNATIONAL: CONTRIBUTE, DOCUMENTS: CONTRIBUTE, NOTIFICATIONS: ["VIEW"],
  },
  MEDICAL_DELEGATE: { DASHBOARD: READ, WORKSPACE: WORKSPACE_USER, MESSAGING: MESSAGING_USER, VALIDATIONS: VALIDATION_USER, DRIVE: DRIVE_USER, ADMIN_REQUESTS: REQUEST_USER, MEDICAL: CONTRIBUTE, CONGRESS_NATIONAL: CONTRIBUTE, CONGRESS_INTERNATIONAL: CONTRIBUTE, NOTIFICATIONS: ["VIEW"] },
  PRODUCT_MANAGER: {
    DASHBOARD: READ, WORKSPACE: WORKSPACE_USER, MESSAGING: MESSAGING_USER, VALIDATIONS: VALIDATION_USER, DRIVE: DRIVE_USER, ADMIN_REQUESTS: REQUEST_USER, CONGRESS_INTERNATIONAL: MANAGE, CONGRESS_NATIONAL: MANAGE, MEDICAL: READ, BUDGETS: READ, DOCUMENTS: CONTRIBUTE, NOTIFICATIONS: ["VIEW"],
  },
