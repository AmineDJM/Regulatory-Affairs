...
| Factures Finances visibles (§22-23) | ✅ order-execution + KPI | ✅ lecture `Invoice sourceType=PCH_ORDER` — rien de fabriqué | ✅ existant | ✅ | — | ✅ chain tests 7/9 | ✅ | ✅ story jalons facture + KPI facturé |
